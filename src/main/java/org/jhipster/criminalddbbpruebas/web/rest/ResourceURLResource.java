...
/**
 * REST controller for managing {@link org.jhipster.criminalddbbpruebas.domain.ResourceURL}.
 */
@RestController
@RequestMapping("/api")
public class ResourceURLResource {
    ...
    public ResponseEntity<ResourceURL> updateResourceURL(@RequestBody ResourceURL resourceURL) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, resourceURL.getId().toString()))
            .body(result);
    }
