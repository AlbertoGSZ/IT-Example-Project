...
describe('Component Tests', () => {
  describe('CaseReport Management Component', () => {
    let comp: CaseReportComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CaseReportComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.caseReports[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
