...
public class CaseReportResourceIT {
    ...
    private static final String DEFAULT_MUGSHOT_URL = "AAAAAAAAAA";
    private static final String UPDATED_MUGSHOT_URL = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_EVIDENCE_PHOTOS_URL = "AAAAAAAAAA";
    private static final String UPDATED_EVIDENCE_PHOTOS_URL = "BBBBBBBBBB";
    ...
    public void setup() {
        ...
        final CaseReportResource caseReportResource = new CaseReportResource(caseReportService, resourceUrlService);
    ...
    public void createCaseReport() throws Exception {
        ...
        assertThat(testCaseReport.getMugshotURL()).isEqualTo(DEFAULT_MUGSHOT_URL);
        ...
        assertThat(testCaseReport.getEvidencePhotosURL()).isEqualTo(DEFAULT_EVIDENCE_PHOTOS_URL);
    }
    ...
    public void getAllCaseReports() throws Exception {
        ...
        restCaseReportMockMvc.perform(get("/api/case-reports?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].mugshotURL").value(hasItem(DEFAULT_MUGSHOT_URL.toString())))
            ...
            .andExpect(jsonPath("$.[*].evidencePhotosURL").value(hasItem(DEFAULT_EVIDENCE_PHOTOS_URL.toString())));
    }
    ...
    public void getCaseReport() throws Exception {
        ...
        restCaseReportMockMvc.perform(get("/api/case-reports/{id}", caseReport.getId()))
            ...
            .andExpect(jsonPath("$.mugshotURL").value(DEFAULT_MUGSHOT_URL.toString()))
            ...
            .andExpect(jsonPath("$.evidencePhotosURL").value(DEFAULT_EVIDENCE_PHOTOS_URL.toString()));
    }
    ...
    public void updateCaseReport() throws Exception {
        ...
        assertThat(testCaseReport.getMugshotURL()).isEqualTo(UPDATED_MUGSHOT_URL);
        ...
        assertThat(testCaseReport.getEvidencePhotosURL()).isEqualTo(UPDATED_EVIDENCE_PHOTOS_URL);
    }
